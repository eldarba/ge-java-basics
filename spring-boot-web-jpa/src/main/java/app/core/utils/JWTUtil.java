...
public class JWTUtil {
	...
	public Client extractClient(String token) throws JwtException {
		...
		app.core.utils.JWTUtil.Client.ClientType clientType = ClientType
				.valueOf(claims.get("clientType", String.class));
		int clientId = claims.get("clientId", Integer.class);
		Client client = new Client("qqq", clientType, clientId);
		return client;
	}
